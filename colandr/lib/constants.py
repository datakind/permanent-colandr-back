...
SCREENING_STATUSES = ('not_screened', 'screened_once', 'conflict', 'included', 'excluded')
USER_SCREENING_STATUSES = ('pending', 'awaiting_coscreener', 'conflict', 'included', 'excluded')
